...
public class QueryService {
    ...
    public static List<ConfigurationResult> getConfigurations(Model model) {
        Query query = QueryBuldingService.createConfigQuery().asQuery();
        ...
        try (QueryExecution qe = QueryExecutionFactory.create(query, model)) {
            ...
            while (!rs.hasNext()) {
                ...
                configurations.add(new  ConfigurationResult(
                        sol.getResource("?anonymizationObject"),
                        ResourceFactory.createProperty(sol.getResource("?attribute").getURI()),
                        sol.getResource("?datatype"),
                        sol.getResource("?anonymization")
                ));
            }
        }
    ...
    public record ConfigurationResult(Resource object, Property attribute, Resource datatype, Resource anonymization) {}
